...
Comprehensive tests for all HR service layer functions including business logic,
validation, and data scope enforcement.
"""
...
from hr.services import DepartmentService, PositionService, GradeService
from hr.dtos import (
    DepartmentCreateDTO,
    DepartmentUpdateDTO,
    PositionCreateDTO,
...
class DepartmentServiceTests(TestCase):
    ...
    def test_create_department_without_data_scope(self):
        """Test that creating department without data scope fails"""
    ...
    def test_update_department_creates_new_version(self):
        """Test that updating creates a new version (date tracking)"""
    ...
    def test_get_department_tree(self):
        """Test getting department hierarchy tree"""
        # Create parent
        parent = Department.objects.create(
            code='PARENT',
            business_group=self.business_group,
...
class PositionServiceTests(TestCase):
    ...
    def test_create_position_with_reporting_line(self):
        """Test creating position with reports_to"""
    ...
    def test_get_position_hierarchy(self):
        """Test getting position reporting hierarchy"""
        # Create manager
        manager = Position.objects.create(
            code='MGR001',
            name='Engineering Manager',
...
class GradeServiceTests(TestCase):
    ...
    def test_create_grade_without_data_scope(self):
        """Test that creating grade without data scope fails"""
        other_bg = BusinessGroup.objects.create(
            enterprise=self.enterprise,
            code='BG002',
            name='Saudi Operations'
    ...
    def test_create_grade_rate_success(self):
        """Test successful grade rate creation"""
        ...
        self.assertEqual(rate.rate_type, 'MIN_SALARY')
    
    def test_create_grade_rate_with_end_date(self):
        """Test creating grade rate with end date"""
        grade = Grade.objects.create(
            code='G1',
            name='Grade 1',
            business_group=self.business_group,
