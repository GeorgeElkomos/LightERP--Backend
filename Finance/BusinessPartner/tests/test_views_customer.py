...
class CustomerAPITests(APITestCase):
    ...
    def test_customer_detail_put(self):
        ...
        response = self.client.put(
            f'/finance/bp/customers/{customer.id}/',
            update_data,
            format='json'
        )
    ...
    def test_customer_toggle_active(self):
        ...
        # Toggle to inactive
        response = self.client.post(f'/finance/bp/customers/{customer.id}/toggle-active/')
    ...
    def test_customer_active_list(self):
        ...
        names = [customer['name'] for customer in response.data]
    ...
    def test_customer_filter_by_country(self):
        ...
        response = self.client.get(f'/finance/bp/customers/?country={self.country_us.id}')
        
        self.assertEqual(len(response.data), 1)
        self.assertEqual(response.data[0]['name'], 'US Customer')
    ...
    def test_customer_filter_by_country_code(self):
        ...
        self.assertEqual(len(response.data), 1)
        self.assertEqual(response.data[0]['name'], 'UK Customer')
