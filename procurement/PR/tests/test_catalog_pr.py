...
class CatalogPRCreateTests(TestCase):
    ...
    def test_create_catalog_pr_success(self):
        ...
        self.assertEqual(response.data['requester_name'], 'John Doe')
        self.assertEqual(response.data['status'], 'DRAFT')
        
        # Verify PR was created
        pr = Catalog_PR.objects.get(pr_id=response.data['pr_id'])
    ...
    def test_create_catalog_pr_auto_generates_pr_number(self):
        ...
        self.assertEqual(response.status_code, status.HTTP_201_CREATED)
        self.assertIsNotNone(response.data['pr_number'])
        self.assertTrue(response.data['pr_number'].startswith('PR-CAT'))
...
class CatalogPRCancelTests(TestCase):
    ...
    def test_cancel_pr_without_reason(self):
        """Test cancelling PR without reason"""
