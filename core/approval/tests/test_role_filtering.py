...
class RoleFilteringTest(TestCase):
    ...
    def setUp(self):
        ...
        self.manager1.role = self.manager_role
        self.manager1.save()
        ...
        self.manager2.role = self.manager_role
        self.manager2.save()
        ...
        self.director.role = self.director_role
        self.director.save()
        ...
        self.supervisor.role = self.supervisor_role
        ...
        self.employee.role = self.employee_role
        self.employee.save()
    ...
    def test_single_role_filter(self):
        ...
        for assignment in assignments:
            self.assertEqual(assignment.user.role, self.manager_role)
    ...
    def test_multiple_stages_different_roles(self):
        ...
        self.assertEqual(assignments2.first().user.role, self.director_role)
    ...
    def test_role_with_no_users_skips_stage(self):
        ...
        empty_role = Role.objects.create(name='cfo')
    ...
    def test_user_without_role_not_assigned(self):
        ...
        # Don't assign a role (role field is nullable)
...
class RoleModelIntegrationTest(TestCase):
    ...
    def test_user_role_relationship(self):
        ...
        role = Role.objects.create(name='test_user_role')
    ...
    def test_role_can_be_null(self):
        ...
        # Should be able to save without role
        user.save()
        user.refresh_from_db()
        self.assertIsNone(user.role)
    ...
    def test_stage_template_role_relationship(self):
        ...
        role = Role.objects.create(name='stage_role')
    ...
    def test_role_deletion_with_set_null(self):
        ...
        role = Role.objects.create(name='deletable_role')
