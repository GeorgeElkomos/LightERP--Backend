...
SECRET_KEY = 'django-insecure-)q6##ui^7qj@x+tv4p4p!jc8_+(a^dyxkl5w6+=^(h(fbw2v&+'
...
REST_FRAMEWORK = {
    ...
    'EXCEPTION_HANDLER': 'erp_project.response_formatter.custom_exception_handler',
    
    # Custom renderer for standardized success responses
    'DEFAULT_RENDERER_CLASSES': [
        'erp_project.response_formatter.StandardizedJSONRenderer',
    ],
}
